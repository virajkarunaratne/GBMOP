    ...
    <div className="min-h-screen bg-neutral-150">
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        <div className="flex items-center gap-3 text-sm text-neutral-600 mb-6">
          <Link href={`/admin/clients/${id}`} className="flex items-center gap-2 text-primary-600 hover:text-primary-700">
          ...
          <CardContent>
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <TextArea
                ...
                onChange={handleChange}
                hint="Update client background or notes"
              />

              <div className="flex items-center justify-end gap-3">
                <Button variant="outline" type="button" onClick={() => router.push(`/admin/clients/${id}`)}>
                  Cancel
                </Button>
